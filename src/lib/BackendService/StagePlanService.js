...
export class StagePlanService {
        ...
        try {
            ...
            if (!_.isEmpty(result.list)) {
                ...
                for (let i = 0; i < months; i++) {
                    ...
                    let hoursPerDay = annualPlan.unitForceTime && annualPlan.unitForceTime.hoursPerDay || 4;
                    let rateAtNight = annualPlan.unitForceTime && annualPlan.unitForceTime.rateAtNight || 15;
    ...
    async addOrUpdateStagePlan(stagePlan) {
        try {
            ...
            let results = await this.backendService.addOrUpdateList('StagePlanItem', planItems);
    ...
    async getStagePlanDetails(objectId) {
        try {
            ...
            this.stagePlan = stagePlan;
            // this.annualPlanItem = await this.backendService.fetchItem('UnitForceAnnualPlanItem', stagePlan.annualPlanItem.objectId);
