...
export class ScoreService {
    ...
    async getTacticsCourses(organization) {
        try {
            ...
            console.log('getTacticsCourses', courses);
            ...
            console.log(`getTacticsCourses failed! exception:${exception}`);
    ...
    async evaluateTacticsScore(courseScores) {
        try {
            ...
            console.log(`evaluateTacticsScore failed! exception:${exception}`);
            let result = parseUtils.getErrorMessage(exception);
            if (this.backendService.errorHandler) this.backendService.errorHandler(exception.code, result);
            throw result;
        }
    ...
    async evaluateLeaderOfficeScore(annualScore) {
        try {
            ...
            console.log(`evaluateLeaderOfficeScore failed! exception:${exception}`);
            let result = parseUtils.getErrorMessage(exception);
            if (this.backendService.errorHandler) this.backendService.errorHandler(exception.code, result);
            throw result;
        }
    ...
    async evaluateUnitForceScore(annualScore) {
        try {
            ...
            console.log('evaluateUnitForceScore', annualScore)

            return score;
        } catch (exception) {
            console.log(`evaluateUnitForceScore failed! exception:${exception}`);
            let result = parseUtils.getErrorMessage(exception);
            if (this.backendService.errorHandler) this.backendService.errorHandler(exception.code, result);
            throw result;
        }
    ...
    async evaluateTroopAnnualScore(annualScore) {
        try{
            ...
            console.log(`evaluateTroopAnnualScore failed! exception:${exception}`);
            let result = parseUtils.getErrorMessage(exception);
            if (this.backendService.errorHandler) this.backendService.errorHandler(exception.code, result);
            throw result;
        }
