...
export class SoldierService {
    ...
    async deleteSoldier(soldierId,personId){
        try{
            let result = await Client.Cloud.run('deleteSoldier', {soldierId: soldierId,personId: personId}, this.backendService.options);
            console.log(result);
            // return result;
        }catch (exception) {
    ...
    async addOrUpdateSoldier(soldierObj) {
        try {
            ...
            let result = await Client.Cloud.run('addOrUpdateSoldier', {soldierObj: soldierObj}, this.backendService.options);
