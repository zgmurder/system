<template>
  <div class="app-container">
    <tree-org
      ...
      border
    />
    <el-button style="display:block;margin:0 auto" @click="formDialogVisible = true" v-else type="primary" icon="el-icon-plus">添加根单位</el-button>
    <el-dialog
      :visible.sync="formDialogVisible"
      width="90%"
      @close="dialogClose"
    >
      <formSchema ref="formSchema" @formFinish="formFinish" :schema="schema" :editing="!!objectId"/>
      <!-- {{schemaObj.name}} -->
    </el-dialog>
  </div>
</template>
