<template>
    <div class="PersonAnnualScoreRule">
        <div class="tip" style="padding: 10px 0"><i style="font-size: 12px;color: #f56c6c;margin-left: 10px">（tip:）提示：个人年度训练成绩，由个人年度内完成的所有单个人员训练课目成绩综合评定。士官，大纲中规定的核心训练课目成绩达不到标准的，年度训练成绩不得评为优秀。</i></div>
