<template>
    <div class="UnitForceAnnualScoreRule">
        <div class="tip" style="padding: 10px 0"><i style="font-size: 12px;color: #f56c6c;margin-left: 10px">（tip:）提示：分队年度训练成绩由本级指挥员（班为班长，排为排长，中队、大队为军政主官、副职）年度训练成绩、下一级单位（班为个人）年度训练成绩和本级战术训练（专业合练）成绩综合评定。因故未完成本级战术训练（专业合练）的分队，分队年度训练成绩由本级指挥员年度训练成绩和下一级单位（班为个人）年度训练成绩综合评定。
        </i></div>
